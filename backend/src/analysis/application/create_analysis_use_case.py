...
from backend.src.analysis.api.model import AnalysisPayload, AnalysisResponse, map_to_response
...
class CreateAnalysisUseCase:
    ...
    async def create(self, analysis_payload: AnalysisPayload) -> AnalysisResponse:
